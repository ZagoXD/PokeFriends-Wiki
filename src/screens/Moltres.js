    ...
    <View style={styles.container}>
        <ImageBackground source={image} resizeMode="cover" style={styles.image}>
            <View style={styles.View2}>
                <TouchableOpacity onPress={normal}><Text style={styles.text}>Prize</Text></TouchableOpacity>
                ...
                {mostrarMapa && <View style={styles.View4}>
                                    <View style={{alignItems: 'center'}}>
                                      <Text style={styles.textInside2}> X: 334 | Y: 1933 | Z: 7 </Text>
                                      <Image style={{margin: 7}} source = { require ('../../assets/images/entranceMoltres.png') }/>
                                      <Image style={{margin: 7}} source = { require ('../../assets/images/moltres1.png') }/>
                                      <Image style={{margin: 7}} source = { require ('../../assets/images/moltres2.png') }/>
                                      <Image style={{margin: 7}} source = { require ('../../assets/images/moltresEnd.png') }/>
                                    </View>
                                  </View>}
                </ScrollView>
            </View>
