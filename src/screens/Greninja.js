            ...
            <View style={styles.View2}>
                                    ...
                                    <View style={{flex: 1, flexDirection: 'row'}}>
                                      <View style={{flex: 1, justifyContent: 'space-around'}}>
                                        <View style= {{flexDirection: 'row'}}>
                                          <Image source = { require ('../../assets/images/ninja.png') }/>
                                        ...
                                        <View style= {{alignItems: 'flex-end', justifyContent: 'center'}}>
                                          <Image tyle= {{width: 10, height: 10}} source = { require ('../../assets/images/shspawn3.png') }/>
                                          <Text style={styles.textInside3}>NPC AT: X: 3327 | Y: 2894 | Z: 10</Text>
                                        </View>
                                    </View>
                                  </View>}
                ...
                {mostrarMapa && <View style={styles.View4}>
                                    <View style={{alignItems: 'center'}}>
                                      <Image style={{margin: 7}} source = { require ('../../assets/images/ninjaspawn.png') }/>
                                      <Text style={styles.textInside2}> X: 2793 | Y: 2586 | Z: 5 </Text>
                                    </View>
                                  </View>}
            </View>
