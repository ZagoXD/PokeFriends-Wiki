            ...
            <View style={styles.View2}>
                ...
                {mostrarNormal && <View style={styles.View3}>
                                    <View style={{flex: 1, justifyContent: 'space-around'}}>
                                      <View style= {{flexDirection: 'row'}}>
                                        <Image source = { require ('../../assets/images/ban.png') }/>
                ...
                {mostrarMapa && <View style={styles.View4}>
                                    <View style={{alignItems: 'center'}}>
                                        <Image style={{margin: 7}} source = { require ('../../assets/images/slakspawn.png') }/>
                                        <Text style={styles.textInside2}> X: 3286 | Y: 2861 | Z: 5 </Text>
                                    </View>
                                  </View>}
            </View>
