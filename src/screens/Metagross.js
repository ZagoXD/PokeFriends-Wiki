            ...
            <View style={styles.View2}>
                ...
                {mostrarNormal && <View style={styles.View3}>
                                    <View style={{flex: 1, justifyContent: 'space-around'}}>
                                      <View style= {{flexDirection: 'row'}}>
                                        <Image source = { require ('../../assets/images/coat.png') }/>
                ...
                {mostrarMapa && <View style={styles.View4}>
                                    <View style={{alignItems: 'center'}}>
                                      <Image style={{margin: 7}} source = { require ('../../assets/images/metspawn.png') }/>
                                      <Text style={styles.textInside2}> X: 3300 | Y: 2844 | Z: 9 </Text>
                                    </View>
                                  </View>}
            </View>
