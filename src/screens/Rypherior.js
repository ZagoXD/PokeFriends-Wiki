            ...
            <View style={styles.View2}>
                ...
                {mostrarNormal && <View style={styles.View3}>
                                    <View style={{flex: 1, justifyContent: 'space-around'}}>
                                      <View style= {{flexDirection: 'row'}}>
                                        <Image source = { require ('../../assets/images/prot.png') }/>
                                    ...
                                    <View style={{flex: 1, flexDirection: 'row'}}>
                                      <View style={{flex: 1, justifyContent: 'space-around'}}>
                                        ...
                                        <View style= {{alignItems: 'flex-end', justifyContent: 'center'}}>
                                          <Image tyle= {{width: 10, height: 10}} source = { require ('../../assets/images/shspawn2.png') }/>
                                          <Text style={styles.textInside3}>NPC AT: X: 3327 | Y: 2894 | Z: 9</Text>
                                        </View>
                                    </View>
                                  </View>}
                ...
                {mostrarMapa && <View style={styles.View4}>
                                    <View style={{alignItems: 'center'}}>
                                      <Image style={{margin: 7}} source = { require ('../../assets/images/rypspawn.png') }/>
                                      <Text style={styles.textInside2}> X: 2798 | Y: 2709 | Z: 6 </Text>
                                    </View>
                                  </View>}
            </View>
